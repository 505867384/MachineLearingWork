...
from LSTMmodel.model import LSTMModel
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('./logs/lstm训练日志.log', mode="a", encoding="utf-8"),
...
def arg_parser():
    ...
    parser.add_argument('--hidden_size',type=int ,default=64,help='lstm中隐藏层的维度')
    parser.add_argument('--num_layers',type=int ,default=1,help='lstm中层数')
