...
from TransformerModel.model import TransformerModel
...
def arg_parser():
    parser = argparse.ArgumentParser(description='Transform训练参数')
    # ---准备数据用到的参数：
    ...
    parser.add_argument('--hidden_size',type=int ,default=64,help='Transformer模型的内部维度 (d_model)')
    parser.add_argument('--nhead', type=int, default=8, help='多头注意力机制中的头数')
    parser.add_argument('--num_encoder_layers', type=int, default=3, help='Transformer编码器的层数')
    parser.add_argument('--dim_feedforward', type=int, default=256, help='前馈神经网络的维度')
